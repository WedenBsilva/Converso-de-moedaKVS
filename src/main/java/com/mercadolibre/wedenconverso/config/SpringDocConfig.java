...
import static com.mercadolibre.wedenconverso.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.wedenconverso.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("wbsilva")
                .email("weden.bsilva@mercadolivre.com"));
